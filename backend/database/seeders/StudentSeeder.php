        ...
        foreach ($students as $studentData) {
            ...
            Student::firstOrCreate(
                ...
                [
                    ...
                    'admission_number' => $studentData['addmission'],
            ...
            // Remove this guardian from the list so it's not reused (1:1)
            $guardians = $guardians->reject(function($g) use ($guardian) {
                return $g->id === $guardian->id;
            });
        }
